    ...
    <div id="main"<?php /* class="container" */ ?>>
      ...
      <section class="mission-statement">
        <div class="container">
          ...
          <p>The Trad Academy believes that it is possible for everyone to enjoy taking part in making music, singing and dancing. Through teaching people participatory folk music, song and dance the Trad Academy want to empower people to self­-organise, make their own entertainment and change the world.</p>
        </div>
      </section>
      ...
      <section class="regular-courses">
        <div class="container">
          ...
          <div class="button">View all our regular courses</div>
      ...
      <section class="tutors">
        <div class="container">
          ...
          <div class="button">View all our tutors</div>
